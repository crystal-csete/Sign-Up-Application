...
This is a Sign up application. Using Mongodb whoever registers correctly, has their login credentials go to a database.

This was created using a create-react-app.
...
Then type: "npm install". Next, in a seperate terminal, repeat the above steps, but go one level deeper, cd into: "signup-backend". Then type: "npm install", to download dependencies.
